        ...
        <div className="container">
            ...
            <div className="row">
                <div style={{ marginTop: "10px" }}>
                    <table className="table" style={{ marginTop: '15px', maxHeight:"500px", height:"500px", marginBottom:"85px" }}>
                        <thead>
                            <tr >
                                <th scope="col">No</th>
                        ...
                        <tbody>
                            {donors && donors.map((item, index) => (
                                <tr key={index}>
                                    ...
                                    <td>{item.phone}</td>
                                    <td>
                                        <MDBBtn color="warning" href={`/edit_donor/${item._id}`}>&nbsp; <i className="fas fa-edit"></i>&nbsp;</MDBBtn>
                                        &nbsp;
