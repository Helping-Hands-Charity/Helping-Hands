...
const HomeView = () => {
    ...
    return (
        <div className="col-12 col-md-12 col-sm-12 col-12">
            <div className="image">
                <img src={home} alt="home image" style={{width:"100%", opacity:"0.8", maxHeight:"700px", position:"absolute", top:"0",bottom:"0",left:"0",right:"0"}}/>
            </div>
            <div className="col-12 col-md-12 col-sm-12 col-12" style={{marginTop:"150px"}}>
                <div className="row">
                    <div className="col-6 col-md-6 col-sm-6 col-6">
                        <div style={{fontSize:"40px", fontFamily:"sans-serif"}}>
                ...
                <div className="row" style={{marginTop:"60px"}}>
                    ...
                    <Link to="/login">
                        <button type="button" className="btn btn-outline-info" style={{position:"absolute", left:"80%",cursor:"pointer", color:"white", borderRadius:"10px"}}>Get Started</button>
                    </Link>
                    </div>
                </div>
            </div>
